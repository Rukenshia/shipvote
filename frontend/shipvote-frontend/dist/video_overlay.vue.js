...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ShipSelection__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__VoteProgress__ = __webpack_require__(31);
  ...
  created: function created() {
    ...
    window.Twitch.ext.onAuthorized(function (authData) {
      ...
      channel.on('new_vote', function (data) {
        var ship = _this.ships.find(function (s) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Ship__ = __webpack_require__(26);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: { Ship: __WEBPACK_IMPORTED_MODULE_0__Ship__["a" /* default */] },
  data: function data() {
    return {};
  },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_09223452_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(35);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_09223452_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
var update = __webpack_require__(1)("0d3172a1", content, true, {});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ShipSelection_vue__ = __webpack_require__(9);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b6f27fbc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ShipSelection_vue__ = __webpack_require__(30);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_b6f27fbc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ShipSelection_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("250420b0", content, true, {});
...
// module
exports.push([module.i, ".card{background-color:#fff;border-radius:4px;padding:8px 12px;overflow:hidden}.card .card__divider{height:12px}.raised{box-shadow:0 3px 1px -2px rgba(0,0,0,.2),0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12)}.ships{display:flex;flex-flow:row wrap;margin-right:-12px}", ""]);
...
// module
exports.push([module.i, ".card{background-color:#fff;border-radius:4px;padding:8px 12px;overflow:hidden}.card .card__divider{height:12px}.raised{box-shadow:0 3px 1px -2px rgba(0,0,0,.2),0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12)}.ship{margin-right:4px;width:calc(48% - 8px);position:relative;display:flex;align-items:center;border-radius:4px;border:1px solid #eaeaea;padding:4px;margin-bottom:4px;overflow:hidden;transition:background-color .2s,border-color .2s}.ship[data-voteable=true]:hover{box-shadow:0 3px 1px -2px rgba(0,0,0,.2),0 2px 2px 0 rgba(0,0,0,.14),0 1px 5px 0 rgba(0,0,0,.12);border-color:#6441a4}.ship[data-voteable=true]:hover .vote-button{visibility:visible;opacity:1;cursor:pointer}.ship *{z-index:1}.ship img{width:20%;margin-right:8px}.ship .progress-bar .progress{transition:background-color .2s}.ship .vote-button{z-index:2;position:absolute;left:0;width:100%;height:100%;display:flex;justify-content:center;align-items:center;text-align:center;color:#fff;font-weight:400;text-transform:uppercase;opacity:0;background-color:#6441a4;transition:opacity .2s}.progress-bar .progress{background-color:rgba(100,65,164,.2);position:absolute;top:0;left:0;height:100%;z-index:0;transition:min-width .2s}", ""]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_VoteProgress_vue__ = __webpack_require__(11);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_67d9859f_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_VoteProgress_vue__ = __webpack_require__(34);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_67d9859f_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_VoteProgress_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("3a861e70", content, true, {});
...
// module
exports.push([module.i, ".vote-progress{position:absolute;left:0;top:0;width:180px;border-bottom-right-radius:8px;background-color:rgba(0,0,0,.5);padding:4px;color:#fff;font-family:Roboto}.mdc-linear-progress{border-radius:8px}", ""]);
