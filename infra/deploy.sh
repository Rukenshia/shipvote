...
aws autoscaling update-auto-scaling-group --auto-scaling-group-name shipvote-web --default-cooldown 20 --min-size "${desired_instances_transition_phase}" --desired-capacity "${desired_instances_transition_phase}" > /dev/null
...
while true; do
	...
	aws autoscaling update-auto-scaling-group --auto-scaling-group-name shipvote-web --default-cooldown 20 --min-size "${desired_instances}" --desired-capacity "${desired_instances}" > /dev/null
